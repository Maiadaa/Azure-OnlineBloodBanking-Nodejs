...
const BloodInventoryRouter = require('./routes/BloodBankInventory');
const BloodBankInventoryRouter = require('./routes/BloodBankInventory');
...
app.use('/BloodInventory', BloodBankInventoryRouter);
